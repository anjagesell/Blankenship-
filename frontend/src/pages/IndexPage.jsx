...
const IndexPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Admin Login Button - Bottom Left (above toast) */}
      {!isAdmin ? (
        <button
          onClick={() => setShowAdminLogin(true)}
          className="fixed bottom-20 left-6 p-3 rounded-full transition-all hover:scale-110 z-40"
          style={{
        ...
        <button
          ...
          className="fixed bottom-20 left-6 px-4 py-2 rounded transition-all hover:scale-105 z-40 flex items-center gap-2"
          style={{
