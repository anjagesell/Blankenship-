...
const IndexPage = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-yellow-600/70 font-normal">Nov 30, 2013 — Geographic Evidence</div>
            </div>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-yellow-600/70 font-normal">AI Legal Assistant — Case Navigator</div>
            </div>
      ...
      {/* Admin Login Button - Bottom Right (above Detective Thomas) */}
      {!isAdmin ? (
        <button
          onClick={() => setShowAdminLogin(true)}
          className="fixed bottom-24 right-6 p-3 rounded-full transition-all hover:scale-110 z-40"
          style={{
        ...
        <button
          ...
          className="fixed bottom-24 right-6 px-4 py-2 rounded transition-all hover:scale-105 z-40 flex items-center gap-2"
          style={{
